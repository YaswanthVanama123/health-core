...
// 8 - min Value
// 9 - Max Value
function CreateNewDeviceDetailChartbyDate(JData, title, legendName, chartDiv, colName, colorsArray, minValue, maxValue) {
...
function CreateNewDeviceDetailChartDbyIndex(JData, title, legendName, chartDiv, colName, colorsArray, minValue, maxValue) {
    var dataTable = new google.visualization.DataTable();
    // Add Data Columns
